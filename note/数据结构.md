...
JS中相关知识点： [原型链、instanceof的实现](./原型链.md)
...
Leetcode相关题：[349两个数组的交集](../leecode/349.两个数组的交集.js)



### 字典/哈希表(Map)

特点：与集合类似，字典也是一种存储唯一值的数据结构，但它是以键值对的形式来存储的，ES6 中的 Map, 也可以用Object来实现

常见操作：键值对的增删改查（Map中的 set、get、has、delete、clear）

Leetcode相关题：

[1两数之和](../leecode/1两数之和)

[3无重复的最小子串](../leecode/3.无重复的最小子串)

[20有效的括号](../leecode/20.有效的括号)

[76最小覆盖子串](../leecode/76.最小覆盖子串)

[349两个数组的交集](../leecode/349.两个数组的交集)
...
概述：是一种特殊的树，一个节点最多只有两个叶子节点，js中使用Object来模拟二叉树
...
[94二叉树的中序遍历](../leecode/94.二叉树的中序遍历.js)

[102二叉树的层序遍历](../leecode/102.二叉树的层序遍历.js)

[104二叉树的最大深度](../leecode/104.二叉树的最大深度.js)

[111二叉树的最小深度](../leecode/111.二叉树的最小深度.js)

[112路径总和](../leecode/112.路径总和.js)
...
[65有效数字](../leecode/65.有效数字.js)

[133克隆图](../leecode/133.克隆图.js)

[417太平洋大西洋水流问题](../leecode/417.太平洋大西洋水流问题.js)
...
![min-heap](/Users/wugenlong/Desktop/js-algorithm/img/min-heap.png)

最大堆：

![max-heap](/Users/wugenlong/Desktop/js-algorithm/img/max-heap.png)
...
![heap-arr](/Users/wugenlong/Desktop/js-algorithm/img/heap-arr.png)

[JavaScript实现最小堆类](../leecode/heap/minHeap.js)
...
[23合并K个排序链表](../leecode/23.合并K个排序链表)

[215数组中的第K个最大元素](../leecode/215.数组中的第K个最大元素.js)

[347前K个高频元素](../leecode/347.前K个高频元素.js)
